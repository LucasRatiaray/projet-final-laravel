    ...
    <div class="sm:ml-64 pt-[64px] min-h-screen">
        <div class="p-4 rounded-lg dark:border-gray-700 py-12 ">
            ...
            <form class="max-w-sm mx-auto" method="POST"
                ...
                <div class="mb-5 flex">
                    <div class="relative w-full">
                        <input type="number" id="width" name="width" value="{{ $product->width }}"
                            class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-s-lg border-e-gray-50 border-e-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                ...
                <div class="mb-5 flex">
                    <div class="relative w-full">
                        <input type="number" id="height" name="height" value="{{ $product->height }}"
                            class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-s-lg border-e-gray-50 border-e-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                ...
                <div class="mb-5 flex">
                    <div class="relative w-full">
                        <input type="number" id="depth" name="depth" value="{{ $product->depth }}"
                            class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-s-lg border-e-gray-50 border-e-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                ...
                <div class="mb-5 flex flex-col">
                    ...
                    <select id="category" name="category_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="" disabled {{ is_null($product->category_id) ? 'selected' : '' }}>
                ...
                <div class="mb-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">SVG, PNG, JPG ou GIF (MAX. 2048Mo).</p>

                    @if ($product->image_url)
                        <div class="mt-4">
                            <span class="block text-sm font-medium text-gray-900 dark:text-white">Image actuelle :</span>
                            <img src="{{ asset('storage/' . $product->image_url) }}" alt="{{ $product->name }} image" class="mt-2 w-32 h-32 object-cover rounded">
                        </div>
                    @endif
                </div>
