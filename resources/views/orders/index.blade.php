                            ...
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @elseif ($o->status === 'delivered')
                                        <span
                                            class="bg-yellow-100 text-yellow-800 me-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">{{ $o->status }}</span>
                                    @elseif ($o->status === 'shipped')
                                        <span
                                            class="bg-blue-100 text-blue-800 me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{ $o->status }}</span>
                                    @elseif ($o->status === 'cancelled')
                                        <span
                                            class="bg-red-100 text-red-800 me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">{{ $o->status }}</span>
                                    @endif
